...
<section class="breadcrumbs">
    <div class="container py-3">
        <p><a href="index.php">Home</a> &nbsp; <i class="fas fa-angle-right"></i> &nbsp;<a href="news.php">News</a> &nbsp; <i class="fas fa-angle-right"></i> &nbsp;<a href="real-estate.php"> Real-Estate </a>&nbsp; <i class="fas fa-angle-right"></i>&nbsp; Strategic and commercial approach with issues </p>
        ...
        <div class="row">
            <div class="col-lg-9">
                <div class="btn top mb-3">
                 ...
                 <div class="title">
                     <h1>Strategic and commercial approach with issues</h1>
                 </div>
                 <div class="comment">
                     <div class="image">
                 ...
                 <div class="title-image my-3">
                     <img src="pics/news3.jpg" width="100%" style="max-height:450px;">
                 </div>
...
<section class="previous bg-light py-5">
    <div class="container">
        <div class="row my-5">
            <a href="news-detail1.php" class="col-lg-6 col-md-6 prev p-5 my-2">
                <div class="container text-white ">
                        <p><i class="fas fa-angle-left mr-2"></i>PREVIOUS</p>
                    <strong>Retail banks wake up to digital lending this year</strong>
                </div>
            </a>
            <div class="col-lg-6 col-md-6 here p-5 my-2">
                <div class="container text-white d-flex justify-content-end flex-wrap">
                    ...
                    <strong class="display:block">Strategic and commercial approach with issues</strong>
                </div>
            </div>
        </div>
