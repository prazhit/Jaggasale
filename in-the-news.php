...
<section class="breadcrumbs">
    <div class="container py-3">
        <p><a href="index.php">Home</a> &nbsp; <i class="fas fa-angle-right"></i> &nbsp; <a href="news.php">News</a> &nbsp; <i class="fas fa-angle-right"></i> &nbsp; In The News </p>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-8 col-md-8 my-4">
                        ...
                        <div class="my-5"> 
                            ...
                            <small class="category">Categories : <a href="real-estate.php">In the news, Real Estate</a></small>
                        </div>
                    </div>
                </div>
                    <div class="row">
