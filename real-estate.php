...
<section class="breadcrumbs">
    <div class="container py-3">
        <p><a href="index.php">Home</a> &nbsp; <i class="fas fa-angle-right"></i> &nbsp; <a href="news.php">News</a> &nbsp; <i class="fas fa-angle-right"></i> &nbsp; Real Estate </p>
                ...
                <div class="row">
                        <div class="col-lg-4 col-md-4">
                            <a href="news-detail2.php" class="card my-4">
                                <img class="img-fluid" src="pics/sale4.jpg">
                        ...
                        <div class="col-lg-8 col-md-8 my-4">
                            ...
                            <div class="my-5"> 
                                <small class="admin">Posted by : <a href="news-detail.php#admin">Admin</a></small>
                        ...
                        <div class="row">
                                <div class="col-lg-4 col-md-4">
                                    <a href="news-detail4.php" class="card my-4">
                                        <img class="img-fluid" src="photo/pet1.jpg">
